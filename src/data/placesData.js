...
export const regions = [
  { id: 'Manila', name: 'Manila', image: 'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?q=80&w=1200&auto=format&fit=crop', desc: 'Historic core of the capital.', typeBadge: 'Cities, Resort Hotels', locationLabel: 'NCR' },
  { id: 'Cebu', name: 'Cebu', image: 'https://images.unsplash.com/photo-1552832230-c0197dd311b5?q=80&w=1200&auto=format&fit=crop', desc: 'Queen City of the South.', typeBadge: 'Beaches, Mountains', locationLabel: 'Central Visayas' },
  { id: 'Palawan', name: 'Palawan', image: 'https://images.unsplash.com/photo-1518509562904-e7ef99cdcc86?q=80&w=1200&auto=format&fit=crop', desc: 'The last frontier.', typeBadge: 'Parks, Beaches', locationLabel: 'MIMAROPA' },
  { id: 'Bohol', name: 'Bohol', image: 'https://images.unsplash.com/photo-1518182170546-0766bd6f6a56?q=80&w=1200&auto=format&fit=crop', desc: 'Nature and heritage.', typeBadge: 'Mountains, Beaches', locationLabel: 'Central Visayas' },
  { id: 'Boracay', name: 'Aklan (Boracay)', image: 'https://images.unsplash.com/photo-1656521161419-ac6889a753f1?q=80&w=1200&auto=format&fit=crop', desc: 'World-famous powdery sands.', typeBadge: 'Beaches, Resorts', locationLabel: 'Western Visayas' },
  { id: 'Banaue', name: 'Ifugao (Banaue)', image: 'https://images.unsplash.com/photo-1528605248644-14dd04022da1?q=80&w=1200&auto=format&fit=crop', desc: 'The eighth wonder of the world.', typeBadge: 'Mountains, Culture', locationLabel: 'North Central Luzon' }
];
...
export const allPlaces = [
    {
        ...
        img: 'https://images.unsplash.com/photo-1571407921666-da644f80c656?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 9.5513, lon: 123.7712, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1493246507139-91e8fad9978e?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/cerro-toco-0.jpg', lat: 9.6133, lon: 123.7718, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/bma-0.jpg', lat: 9.6366, lon: 124.0322, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1520626337972-8ee434ee744c?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 11.1477, lon: 119.3828, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1540541338287-41700207dee6?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 9.7548, lon: 118.7610, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 11.2001, lon: 119.4184, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1582719508461-905c673771fd?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 11.9804, lon: 121.9126, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1544253303-346c19694f6e?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 11.9781, lon: 121.9137, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 11.9664, lon: 121.9234, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1571896349842-6e5a51335022?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 10.3060, lon: 124.0189, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1561501900-3701fa6a36a6?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 10.3340, lon: 123.8932, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1590523277543-a94d2e4eb00b?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 9.9485, lon: 123.3644, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1542314831-c6a420325142?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 14.5866, lon: 120.9762, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1513407030348-51e4ec7950fa?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 14.5350, lon: 120.9829, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1559812239-65a4eeb755de?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 14.5161, lon: 120.9824, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1540611025311-01df3cef54b5?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 16.9032, lon: 121.0556, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 16.9116, lon: 121.0601, 
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1575406811594-da848ffb8a50?q=80&w=1200&auto=format&fit=crop', panorama: 'https://pannellum.org/images/alma.jpg', lat: 16.9200, lon: 121.0650, 
...
export const tourPackages = [
    { id: 'Tour-ElNido', name: 'El Nido Island Paradise', price: 34999, duration: '4 Days / 3 Nights', img: 'https://images.unsplash.com/photo-1531168556467-8053153c361c?q=80&w=1200&auto=format&fit=crop', type: 'Diving / Beach' },
    { id: 'Tour-Bohol', name: 'Bohol Adventure Package', price: 25999, duration: '3 Days / 2 Nights', img: 'https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?q=80&w=1200&auto=format&fit=crop', type: 'Nature / Sightseeing' },
    { id: 'Tour-Boracay', name: 'Boracay Beach Escape', price: 39999, duration: '5 Days / 4 Nights', img: 'https://images.unsplash.com/photo-1588698944583-0498b25350c3?q=80&w=1200&auto=format&fit=crop', type: 'Beach / Relaxation' },
    { id: 'Tour-Cebu', name: 'Cebu Canyoneering', price: 22999, duration: '3 Days / 2 Nights', img: 'https://images.unsplash.com/photo-1573551089778-46a7abc39d9f?q=80&w=1200&auto=format&fit=crop', type: 'Adventure / Diving' },
    { id: 'Tour-Banaue', name: 'Banaue Heritage Tour', price: 28999, duration: '4 Days / 3 Nights', img: 'https://images.unsplash.com/photo-1711060169357-ed923c9f2156?q=80&w=1200&auto=format&fit=crop', type: 'Culture / Mountains' },
    { id: 'Tour-Manila', name: 'Manila City Escape', price: 16999, duration: '2 Days / 1 Night', img: 'https://images.unsplash.com/photo-1542314831-c6a420325142?q=80&w=1200&auto=format&fit=crop', type: 'City / History' }
];