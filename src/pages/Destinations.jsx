                                            ...
                                            <div key={place.id} className="col-md-6 destination-card scroll-reveal visible">
                                                ...
                                                <div className="card h-100">
                                                    ...
                                                    <div className="card-body">
                                                        ...
                                                        <div className="mt-auto">
                                                            <a href="#" className="explore-link border-0 bg-transparent p-0 text-start w-100 d-flex justify-content-between align-items-center" onClick={(e) => { e.preventDefault(); handleOpenDetail(place); }}>
                                                                <span>{t('view_details', 'View Details')}</span> <i className="fa-solid fa-arrow-right text-accent"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
