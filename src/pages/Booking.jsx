...
const Booking = () => {
  ...
  // ⚡ UPDATED: Infants are now excluded from Transfer, Dinner, and Carbon Offset
  const transferTotal = addons.airportTransfer ? (addonPrices.airportTransfer * chargeablePax) : 0;
  const insuranceTotal = addons.insurance ? (addonPrices.insurance * totalHeads) : 0; // Keeping insurance for all heads
  ...
  return (
    <div className="fade-in" style={{ backgroundColor: 'var(--bg-dark)' }}>
        <section className="booking-hero" style={{ marginTop: 0, backgroundImage: `url("${heroImg}")`, backgroundSize: 'cover', backgroundPosition: 'center', height: '40vh', minHeight: '300px' }}>
                        ...
                        <div className="d-flex flex-column flex-md-row gap-3 mb-4">
                            ...
                            <div className="d-flex align-items-center rounded-3 px-3 py-2 border border-primary border-opacity-25 flex-grow-1" style={{ backgroundColor: '#F4FAFC' }}>
                                <div className="me-auto">
                                    ...
                                    {/* ⚡ UPDATED: Changed string from "Free (Under 2)" */}
                    ...
                    <div className="bg-card-dark p-4 rounded-4 shadow-sm border border-primary border-opacity-10 sticky-top" style={{ backgroundColor: 'var(--card-bg)', top: '100px' }}>
                        ...
                        {!selectedPackage ? (
                            ...
                            <div className="fade-in">
                                ...
                                {/* ⚡ UPDATED: Changed totalHeads to chargeablePax */}
