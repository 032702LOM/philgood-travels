      ...
      <div className="container">
        <div className="bg-card-dark p-5 rounded-4 shadow-lg border border-primary border-opacity-10" style={{ backgroundColor: 'var(--card-bg)' }}>
          ...
          <div className="text-center mb-5">
            ...
            />
            <h1 className="text-navy font-montserrat fw-bold">Terms and Conditions</h1>
            <p className="text-grey">Last Updated: April 11, 2026</p>
          </div>

          <div className="text-grey" style={{ lineHeight: '1.8' }}>
            <h4 className="text-white font-montserrat fw-bold mt-4 mb-3">1. Account Registration and Security</h4>
            <ul className="mb-4">
            ...
            <h4 className="text-white font-montserrat fw-bold mt-4 mb-3">2. Booking and Payments</h4>
            <ul className="mb-4">
            ...
            <h4 className="text-white font-montserrat fw-bold mt-4 mb-3">3. Cancellations, Postponements, and Refunds</h4>
            <ul className="mb-4">
            ...
            <h4 className="text-white font-montserrat fw-bold mt-4 mb-3">4. User Conduct</h4>
            <p className="mb-4">
