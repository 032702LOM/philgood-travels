  ...
  return (
    <div className="fade-in">
        ...
        <div className="top-alert" id="specialOfferBanner">
            <span><i className="fa-solid fa-sun me-2"></i> MONSOON SPECIAL: 30% OFF on all Palawan packages! Limited time only!</span>
            <i className="fa-solid fa-xmark close-alert" onClick={(e) => e.target.parentElement.style.display='none'}></i>
        </div>
        ...
        <section className="scene-section trail-makers-bg" style={{ backgroundImage: "url('https://i.postimg.cc/9MkYFcs3/man_on_the_cliff.png')" }}>
            <div className="container">
                ...
                <div className="row g-4">
                    <div className="col-md-4 scroll-reveal visible">
                        <div className="testimonial-item">
                            ...
                            <p className="quote">"PhilGood Travels made our El Nido trip absolutely unforgettable! The team was professional and the experiences were beyond amazing."</p>
                        </div>
                    </div>
                    <div className="col-md-4 scroll-reveal visible">
                        <div className="testimonial-item">
                            ...
                            <p className="quote">"The Chocolate Hills tour was breathtaking! Everything was well-organized and our guide was incredibly knowledgeable."</p>
                        </div>
                    </div>
                     <div className="col-md-4 scroll-reveal visible">
                        <div className="testimonial-item">
                            ...
                            <div className="stars"><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i></div>
                            <p className="quote">"As a first-time visitor to the Philippines, I was impressed by the service and beautiful destinations. Highly recommend!"</p>
                        </div>
                    </div>
                </div>
            </div>
