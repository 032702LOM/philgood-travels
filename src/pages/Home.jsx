    ...
    <div className="fade-in">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active" style={{ backgroundImage: `url(${islandParadiseImg})` }}>
                        <div className="hero-overlay">
                            <div className="container scroll-reveal visible text-center">
                                ...
                                <Link to="/booking" className="hero-btn mt-2">{t('book_now', 'BOOK NOW')}</Link>
                            </div>
                        </div>
                    </div>
        ...
        <div className="container py-5">
            <div className="stats-container row text-center g-4">
                ...
                <div className="col-md-4"><div className="stat-card scroll-reveal visible delay-1"><i className="fa-regular fa-calendar-check"></i><h3 className="stat-number">3,500+</h3><span className="stat-label">TOURS ORGANIZED</span></div></div>
                <div className="col-md-4"><div className="stat-card scroll-reveal visible delay-2"><i className="fa-solid fa-location-dot"></i><h3 className="stat-number">50+</h3><span className="stat-label">DESTINATIONS</span></div></div>
            </div>
        </div>

        {/* ⚡ SCENE 1: MAN ON CLIFF ⚡ */}
        <section className="scene-section trail-makers-bg">
            <div className="container">
                ...
                <div className="row align-items-center scene-block scroll-reveal visible">
                    <div className="col-lg-6">
                        <div className="scene-content pe-lg-5">
                            ...
                            <h2 className="scene-title wave-text">Soak in the Sun</h2>
                            <p className="scene-text">Unwind under the tropical canopy. Feel the warmth of the sun on your skin and the gentle island breeze.</p>
        ...
        <section className="py-5" style={{ backgroundColor: 'var(--bg-dark)' }}>
            <div className="container py-5">
                ...
                <div className="row g-4">
                    <div className="col-md-4 scroll-reveal visible"><div className="testimonial-item"><img src="https://randomuser.me/api/portraits/men/32.jpg" className="testimonial-img" alt="Client" /><h5 className="client-name">Mario Santos</h5><p className="client-loc">Manila</p><div className="stars"><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i></div><p className="quote">"PhilGood Travels made our El Nido trip absolutely unforgettable! The team was professional and the experiences were beyond amazing."</p></div></div>
                    <div className="col-md-4 scroll-reveal visible delay-1"><div className="testimonial-item"><img src="https://randomuser.me/api/portraits/men/45.jpg" className="testimonial-img" alt="Client" /><h5 className="client-name">John Reyes</h5><p className="client-loc">Cebu</p><div className="stars"><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star-half-stroke"></i></div><p className="quote">"The Chocolate Hills tour was breathtaking! Everything was well-organized and our guide was incredibly knowledgeable."</p></div></div>
                    <div className="col-md-4 scroll-reveal visible delay-2"><div className="testimonial-item"><img src="https://randomuser.me/api/portraits/women/44.jpg" className="testimonial-img" alt="Client" /><h5 className="client-name">Sarah Chen</h5><p className="client-loc">Singapore</p><div className="stars"><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i></div><p className="quote">"As a first-time visitor to the Philippines, I was impressed by the service and beautiful destinations. Highly recommend!"</p></div></div>
                </div>
            </div>
        </section>

        {/* --- CTA --- */}
        <section className="cta-section scroll-reveal visible">
