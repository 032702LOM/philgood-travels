  ...
  return (
    <div className="fade-in" style={{ paddingTop: '76px' }}>
      ...
      <section className="contact-hero" style={{ 
          backgroundImage: "linear-gradient(to bottom, rgba(2, 26, 46, 0.7), var(--bg-dark)), url('https://images.unsplash.com/photo-1518439179707-1b0b7531776b?q=80&w=2000&auto=format&fit=crop')",
          ...
          <div className="container text-center mb-4 scroll-reveal visible">
              ...
              <p className="section-desc mb-0">We are here to help you plan your dream vacation</p>
          </div>
      </section>
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-5 scroll-reveal visible">
              ...
              <div className="d-flex align-items-start mb-4">
                <div className="icon-box me-3 mt-1" style={{ fontSize: '1.5rem', color: '#E76F51' }}>
                  <i className="fa-solid fa-location-dot"></i>
                </div>
                <div>
                  <h5 className="font-montserrat fw-bold text-white mb-1">Our Office</h5>
                  <p className="text-white-50 mb-0">123 Travel Street<br/>Makati City, Metro Manila<br/>Philippines</p>
                </div>
              </div>
              ...
              <div className="d-flex align-items-start mb-4">
                ...
                <div>
                  <h5 className="font-montserrat fw-bold text-white mb-1">Phone</h5>
                  <p className="text-white-50 mb-0">+63 123 456 7890<br/>+63 098 765 4321</p>
                </div>
              </div>
              ...
              <div className="d-flex align-items-start mb-4">
                ...
                <div>
                  <h5 className="font-montserrat fw-bold text-white mb-1">Email</h5>
                  <p className="text-white-50 mb-0">hello@philgoodtravels.com<br/>support@philgoodtravels.com</p>
                </div>
              </div>
              ...
              <div className="d-flex gap-3">
                  {/* Now using the global social-btn class! */}
            ...
            <div className="col-lg-7 scroll-reveal visible">
              {/* Now using the global bg-card-dark class! */}
                ...
                <form onSubmit={handleSubmit}>
                  <div className="row g-4">
                    <div className="col-md-6">
                      <label className="text-white-50 small mb-2">Your Name</label>
                    ...
                    <div className="col-md-6">
                      <label className="text-white-50 small mb-2">Your Email</label>
                    ...
                    <div className="col-12">
                      <label className="text-white-50 small mb-2">Subject</label>
                      <input type="text" name="subject" value={formData.subject} onChange={handleChange} className="form-control-dark w-100 shadow-none" placeholder="How can we help?" required />
                    </div>
                    <div className="col-12">
                      <label className="text-white-50 small mb-2">Message</label>
                      <textarea name="message" value={formData.message} onChange={handleChange} className="form-control-dark w-100 shadow-none" style={{ minHeight: '150px' }} placeholder="Write your message here..." required></textarea>
                    </div>
                    <div className="col-12 mt-4 pt-2">
                      <button type="submit" className="btn btn-proceed w-100 py-3 text-uppercase font-montserrat fw-bold">Send Message</button>
                    </div>
                  </div>
                </form>
